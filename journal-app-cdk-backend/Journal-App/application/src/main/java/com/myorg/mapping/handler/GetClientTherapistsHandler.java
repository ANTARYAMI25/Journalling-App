...
public class GetClientTherapistsHandler implements RequestHandler<Map<String, Object>, Map<String, Object>> {
    private final MappingService mappingService;
    private final ObjectMapper objectMapper = new ObjectMapper();

    public GetClientTherapistsHandler() {
    ...
    public Map<String, Object> handleRequest(Map<String, Object> input, Context context) {
        try {
            ...
            if (pathParameters == null || !pathParameters.containsKey("clientId")) {
                return buildErrorResponse(400, "Missing clientId in path parameters");
            }

            String clientId = (String) pathParameters.get("clientId");


            List<Mapping> mappings = mappingService.getTherapistsForClient(clientId);
