...
public class TherapistRequestClientMappingHandler implements RequestHandler<Map<String, Object>, Map<String, Object>> {
    private final MappingService mappingService;
    private final ObjectMapper objectMapper = new ObjectMapper();

    public TherapistRequestClientMappingHandler() {
    ...
    public Map<String, Object> handleRequest(Map<String, Object> input, Context context) {
        try {
            ...
            Mapping mapping = mappingService.therapistRequestMapping(clientId, therapistId);
