...
public class UpdateMappingStatusHandler implements RequestHandler<Map<String, Object>, Map<String, Object>> {
    private final MappingService mappingService;
    private final ObjectMapper objectMapper = new ObjectMapper();

    public UpdateMappingStatusHandler() {
    ...
    public Map<String, Object> handleRequest(Map<String, Object> input, Context context) {
        try {
            ...
            if (!requestBody.containsKey("status")) {
                return buildErrorResponse(400, "Status field is required");
            }

            String status = (String) requestBody.get("status");


            Mapping mapping = mappingService.updateMappingStatus(clientId, therapistId, status);
