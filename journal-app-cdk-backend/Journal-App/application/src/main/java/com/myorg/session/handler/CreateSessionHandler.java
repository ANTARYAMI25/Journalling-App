...
public class CreateSessionHandler implements RequestHandler<Map<String, Object>, Map<String, Object>> {
    ...
    public Map<String, Object> handleRequest(Map<String, Object> input, Context context) {
        try {
            ...
            Session session = sessionService.createSession(therapistId, title, scheduledAt, 
                    durationMinutes, privateNotes, sharedNotes, location);
